...
ZL1:;
	{
		...
		{
#line 234 "lib/parser.act"

		fprintf(stderr, "syntax error\n");
	
#line 382 "lib/parser.c"
		}
...
#line 150 "lib/parser.act"
		...
		v = bib_new_value((ZIv), normalisecase);
		if (v == NULL) {
